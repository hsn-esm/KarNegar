...
object WorkCalculator {
     ...
     * @param rules قاعده‌های مناسبت دریافتی از مخزن؛ خالی باشد، جدول درون‌برنامه‌ای مبناست
     */
    fun summarize(
        year: Int,
        month: Int,
        ...
        for (e in monthEntries) {
            ...
            holidayWork += e.holidayWorkMinutes(
                isShiftDayOff = Holidays.isDayOff(day, overrides, rules),
                ...
                isNextDayOff = Holidays.isDayOff(day.plusDays(1), overrides, rules)
            )
